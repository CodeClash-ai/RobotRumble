...
results_1 = [run_match("robot.py", "anton4000.py") for _ in range(10)]
results_2 = [run_match("anton4000.py", "robot.py") for _ in range(10)]
...
print(f"As Blue vs anton4000 (Red): wins: {blue_wins_1}, losses: {red_wins_1}, ties: {ties_1}")
print(f"As Red vs anton4000 (Blue): wins: {red_wins_2}, losses: {blue_wins_2}, ties: {ties_2}")
