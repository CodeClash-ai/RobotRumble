...
class Score:
    ...
    def __eq__(self, other) -> bool:
        return (self.points, self.health) == (other.points, other.health)
    ...
    def __le__(self, other) -> bool:
        return self.points <= other.points or (
            self.points == other.points and self.health <= self.other_health)

    def __lt__(self, other) -> bool:
        return self.points < other.points or (self.points == other.points and
                                              self.health < self.other_health)

    def __repr__(self) -> str:
        return "Score(%dp/%dh | %dp/%dh )" % (self.our_points, self.our_health,
                                              self.other_points,
                                              self.other_health)
...
def simulate_attack(state: State, score: Score, to: Coords, team: Team) -> Score:
