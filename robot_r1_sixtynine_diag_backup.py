...
def robot(state,unit):
    ...
    if focus is not None and unit.coords.walking_distance_to(focus.coords)<=9: tgt=focus
    best=None
    for d in DIRECTIONS:
        nc=unit.coords+d
        ...
        # pin: if this tile is adjacent to the target and lies on the center-side of it,
        ...
        diag=cDiag(nc)
        best_key=(dist,pin,th,diag,cdist,th-su)
