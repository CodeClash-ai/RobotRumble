...
def _score(friends, enemies):
    ...
    if CURRENT_TURN >= 20 and unit_score <= 0:
        ...
        # before a snowball forms. Threshold moved 40->30 after round0 and
        # 30->20 after round1 because borg losses already diverge by turns 20-30.
